...
const skill3 = [{list: ["WordPress Websites", "Google Sites ", "Photography", "Retouching", "Co-ordinating With Developers", "Lighting Set Up", "Social Media", "Image Manipulation", "HTML", "CSS"]}]
